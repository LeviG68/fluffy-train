...
exports.updateStore = async (req, res) => {
    ...
    const store = await Store.findOneAndUpdate({ _id: req.params.id}, req.body, {new: true, // return the new store instead of the old store
    runValidators: true
}).exec();
