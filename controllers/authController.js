...
exports.isLoggedIn = (req, res, next) => {
  //frist check if the user is authenticated
...
exports.reset = async (req, res) => {
  const user = await User.findOne({
    resetPasswordToken: req.parmas.token,
  ...
  // if there is a user show the reset passowrd form
  res.render('reset', { title: 'Reset your Password'});
};

exports.confirmedPasswords = (req, res, next) => {
  if (req.body.password === req.body['password-confrim']) {
    next(); // keep it going
    return;
  }
